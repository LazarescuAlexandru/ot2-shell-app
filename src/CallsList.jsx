...
const getServiceUrl = (type) => {
  switch (type) {
    ...
    case 'admin':
      return 'https://developer.opentext.com/imservices/developertools/developeradmin/apis/imdeveloperadministrationapi'
    case 'css':
          ...
          <CardContentNoPadding>
            ...
            <Stack direction="row" spacing={2} justifyContent="space-between" alignItems="center">
              <Typography variant="body2" color={(call.status==="SUCCESS")?"success.main":"error.main"}>
                {`${call.status}${(call.statusCode && call.statusCode>0) ? ` (${call.statusCode})` : ''}`}
              </Typography>
              <ExpandMore
                expand={expanded}
